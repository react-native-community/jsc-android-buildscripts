...
$TARGETDIR/webkit/Tools/Scripts/build-webkit \
  ...
  -DPLIST_LIBRARIES='$TARGETDIR/plist/${CROSS_COMPILE_PLATFORM}-${FLAVOR}/src/.libs/libplist.so' \
  -DPLISTXX_LIBRARIES='$TARGETDIR/plist/${CROSS_COMPILE_PLATFORM}-${FLAVOR}/src/.libs/libplist++.so' \
  -DPLIST_INCLUDE_DIRS='$TARGETDIR/plist/include' \
  -DENABLE_API_TESTS=0 \
